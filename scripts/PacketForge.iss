...
OutputBaseFilename=PacketForge_Setup
SetupIconFile=..\Files\Images\app_icon.ico
Compression=lzma2
...
[Files]
; Main executable and Qt dependencies (use release_dist where windeployqt was run)
